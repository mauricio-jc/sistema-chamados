...
function CustomersEdit() {
    ...
    useEffect(() => {
        ...
        axios.get(Url('/customers/get.php'), {
            params: {
                id: id
            }
        })
        .then(response => {
            modalLoadingClose();
            setFields(response.data.customer);
        })
        .catch(error => {
            modalLoadingClose();
            alert('Problemas ao buscar os dados co cliente.');
        });
    ...
    function handleEditCustomer() {
        ...
        axios.post(Url('/customers/update.php'), JSON.stringify(data), headers)
        .then(response => {
            modalLoadingClose();
    ...
    return(
        <Layout>
            ...
            <form className="row">
                ...
                <div className="form-group col-md-12">
                    <button type="button" className="btn btn-primary" onClick={ handleEditCustomer }>Editar</button>
                </div>
            </form>
